...
dofile(core.get_modpath("mymagic_wands") .. "/register.lua")
dofile(core.get_modpath("mymagic_wands") .. "/fire_wand.lua")
dofile(core.get_modpath("mymagic_wands") .. "/water_wand.lua")
dofile(core.get_modpath("mymagic_wands") .. "/earth_wand.lua")
dofile(core.get_modpath("mymagic_wands") .. "/air_wand.lua")
...
--    description = "Terra Digger - 3×3 Tunnel (Length 5) & Whirlwind Effect",
...
--    },
--
--    -- PRIMARY USE: Digs a 3x3 tunnel (length 5).
--    on_use = function(itemstack, user, pointed_thing)
...
--    end,
--
--    -- SECONDARY USE: Cast a whirlwind at a target.
--    on_secondary_use = function(itemstack, user, pointed_thing)
...
>>>>>>> 4ef446ce9c1199e54f1eb40ee8fb63890516c9e7
